...
Я это ещё не пробовал, но сегодня я узнал, что [Flutterwonder](https://www.wikihow.com/Create-an-UTAU-Voicebank-with-Audacity|можно нарезать аудиофайлы на звуки и синтезировать из них голос]] сделана для озвучки японских песен, но она работает и с обычной речью ([[https://youtube.com/watch?v=j13VAEaIWAs|пример]]). Попробуйте сделать записи исполнения песен или, ещё лучше, разговорной речи голоса вашей тульпы. В принципе, не обязательно использовать осмысленные слова: пусть голос вашей тульпы говорит или поёт абракадабру, например, [[https://youtube.com/watch?v=dfj0GjzyUSE) прекрасно подойдёт для имплантирования.
